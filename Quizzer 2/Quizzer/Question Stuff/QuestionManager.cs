...
get{ return _totalQuestion.RightPercentage; }
	...
	if (wPercent > 0.5){
        return Color.FromArgb(Convert.ToByte(255), Convert.ToByte(255), Convert.ToByte(75 + cPercent * 2.0 * 180.0), Convert.ToByte(75));
 	} 
    else {
		return Color.FromArgb(Convert.ToByte(255), Convert.ToByte(75 + 180.0 * wPercent * 2.0), Convert.ToByte(255), Convert.ToByte(75)); 
	}
}
